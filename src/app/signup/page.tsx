...
export default function SignupPage() {
  ...
  const isFormValid = isEmailValid && isPasswordValid && doPasswordsMatch && businessName.trim() !== "";
        ...
        <CardContent className="px-6 sm:px-10 pb-10">
          {!success ? (
            <div className="space-y-4">
              <Button variant="outline" className="w-full mb-6 h-10 text-[13px] font-medium border-border/60" onClick={handleGoogleSignup} disabled={loading} type="button">
